...
<div class="formdata">
    <fieldset>
        ...
        <div class="formRow">
            <label for="namabarang">Code :</label>
            <div class="formRight">
				<?php if ($type == 'update') {				
					echo '<input class="form-control input-sm" type="text" name="ct_desc" id="ct_desc" value="'. $query['kode'] .'" style="width: 350px;" />';
				}else{
        ...
        <div class="formRow">
            <label for="namabarang">Symbol :</label>
            <div class="formRight">
				<?php if ($type == 'update') {				
					echo '<input class="form-control input-sm" type="text" name="ct_desc" id="ct_desc2" value="'. $query['simbol'] .'" style="width: 350px;" />';
				}else{
					echo '<input class="form-control input-sm" type="text" name="ct_desc" id="ct_desc2" value="" style="width: 350px;" />';					
				}
				?>
            </div>
            <div class="clear"></div>
